...
const uint32_t NTOKENS = 1024;      // TOKEN大小
const uint32_t HIDDENSIZEQ = 640; // Q 隐藏层大小
const uint32_t HIDDENSIZEK = 128; // K 隐藏层大小
...
int main(int argc, char **argv)
{
    ...
    // 准备输入张量ropeQ和ropeK
    atb::Tensor ropeQ;
    CHECK_STATUS(CreateTensor(ACL_BF16, aclFormat::ACL_FORMAT_ND, {NTOKENS, HIDDENSIZEQ}, ropeQ));
    atb::Tensor ropeK;
    CHECK_STATUS(CreateTensor(ACL_BF16, aclFormat::ACL_FORMAT_ND, {NTOKENS, HIDDENSIZEK}, ropeK));
