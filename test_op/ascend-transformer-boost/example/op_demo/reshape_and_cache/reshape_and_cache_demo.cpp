...
atb::Status PrepareVariantPack(atb::Context *contextPtr, aclrtStream stream, atb::VariantPack &variantPack)
{
    ...
    CHECK_STATUS(CreateTensorFromVector(contextPtr, stream, kCacheData, ACL_FLOAT16, aclFormat::ACL_FORMAT_ND,
    ...
    CHECK_STATUS(CreateTensorFromVector(contextPtr, stream, vCacheData, ACL_FLOAT16, aclFormat::ACL_FORMAT_ND,
