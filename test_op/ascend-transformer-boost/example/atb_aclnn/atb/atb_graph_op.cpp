...
template<typename E>
constexpr auto toU(E e) noexcept -> std::underlying_type_t<E>
{
...
atb::Status CreateGraphOperation(atb::Operation **operation)
{
    ...
    addNode.inTensorIds = {toU(InTensorId::IN_TENSOR_A), toU(InTensorId::IN_TENSOR_B)};
    addNode.outTensorIds = {toU(InTensorId::ADD1_OUT)};
    ...
    addNode2.inTensorIds = {toU(InTensorId::IN_TENSOR_C), toU(InTensorId::IN_TENSOR_D)};
    addNode2.outTensorIds = {toU(InTensorId::ADD2_OUT)};
    ...
    addNode3.inTensorIds = {toU(InTensorId::ADD1_OUT), toU(InTensorId::ADD2_OUT)};
    addNode3.outTensorIds = {toU(InTensorId::ADD3_OUT)};
