...
public:
    ...
    // Check data infos
    static_assert(
        std::is_same_v<ElementC, int32_t> && std::is_same_v<ElementD, float>,
    ...
    using TileStrideDiv = Tile::TileStrideDiv<ArchTag, float, ChunkTileShape,
        ChunkTileShape::COLUMN, TileShape::COLUMN, ChunkTileShape::COLUMN>;
    using TileStrideMul = Tile::TileStrideMul<ArchTag, float, ChunkTileShape,
        ChunkTileShape::COLUMN, TileShape::COLUMN, ChunkTileShape::COLUMN>;
    ...
    static_assert(
        (UB_STAGES * (TileShape::COUNT * sizeof(ElementC) + TileShape::COLUMN * sizeof(ElementScale)
            ...
            + (TileShape::COUNT + ChunkTileShape::COUNT) * sizeof(float)
