...
void gmm_deq_swiglu_quant_gmm_deq_n256(
    GM_ADDR fftsAddr,
    GM_ADDR gmX1,
...
)
{
    ...
    using Gmm1EpilogueTileShape = MatrixShape<Gmm1TileArgs<PERMUTE_N256>::EPIM, Gmm1L1TileShape::N>;
...
static const struct FunLevelMixCoreType gmm_deq_swiglu_quant_gmm_deq_n256_0_mix_aic_section
__attribute__ ((used, section (".ascend.meta.gmm_deq_swiglu_quant_gmm_deq_n256_0_mix_aic"))) = {
    {
        {
            F_TYPE_KTYPE,
            sizeof(unsigned int)
...
static const struct FunLevelMixCoreType gmm_deq_swiglu_quant_gmm_deq_n256_0_mix_aiv_section
__attribute__ ((used, section (".ascend.meta.gmm_deq_swiglu_quant_gmm_deq_n256_0_mix_aiv"))) = {
    {
        {
            F_TYPE_KTYPE,
            sizeof(unsigned int)
