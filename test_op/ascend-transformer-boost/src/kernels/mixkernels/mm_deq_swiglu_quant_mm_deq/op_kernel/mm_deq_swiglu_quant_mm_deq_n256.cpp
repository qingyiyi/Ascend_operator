...
void mm_deq_swiglu_quant_mm_deq_n256(
    GM_ADDR fftsAddr,
    GM_ADDR gmX1,
...
)
{
    ...
    using Mm1L1TileShape = GemmShape<Mm1TileArgs<PERMUTE_N256>::L1M, Mm1TileArgs<PERMUTE_N256>::L1N, MM1_L1K>;
    using Mm1L0TileShape = GemmShape<Mm1L1TileShape::M, Mm1L1TileShape::N, MM1_L0K>;
    using Mm1EpilogueTileShape = MatrixShape<Mm1TileArgs<PERMUTE_N256>::EPIM, Mm1L1TileShape::N>;
...
static const struct FunLevelMixCoreType mm_deq_swiglu_quant_mm_deq_n256_0_mix_aic_section
__attribute__ ((used, section (".ascend.meta.mm_deq_swiglu_quant_mm_deq_n256_0_mix_aic"))) = {
    {
        {
            F_TYPE_KTYPE,
            sizeof(unsigned int)
...
static const struct FunLevelMixCoreType mm_deq_swiglu_quant_mm_deq_n256_0_mix_aiv_section
__attribute__ ((used, section (".ascend.meta.mm_deq_swiglu_quant_mm_deq_n256_0_mix_aiv"))) = {
    {
        {
            F_TYPE_KTYPE,
            sizeof(unsigned int)
