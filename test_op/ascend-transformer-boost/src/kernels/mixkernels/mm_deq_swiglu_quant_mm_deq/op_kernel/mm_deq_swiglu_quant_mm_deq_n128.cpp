 ...
 */
#include "mm_deq_swiglu_quant_mm_deq.h"

extern "C" __global__ __aicore__
void mm_deq_swiglu_quant_mm_deq_n128(
    GM_ADDR fftsAddr,
    GM_ADDR gmX1,
...
)
{
    ...
    GemmCoord mm1ProblemShape{m, n, k};
    ...
    using Mm1L1TileShape = GemmShape<Mm1TileArgs<PERMUTE_N128>::L1M, Mm1TileArgs<PERMUTE_N128>::L1N, MM1_L1K>;
    using Mm1L0TileShape = GemmShape<Mm1L1TileShape::M, Mm1L1TileShape::N, MM1_L0K>;
    using Mm1EpilogueTileShape = MatrixShape<Mm1TileArgs<PERMUTE_N128>::EPIM, Mm1L1TileShape::N>;

    MmDeqSwigluQuant<Mm1L1TileShape, Mm1L0TileShape, Mm1EpilogueTileShape>(
        mm1ProblemShape, gmX1, layoutX1, gmPermuteWeight1, layoutWeight1,
    ...
    GemmCoord mm2ProblemShape{m, n2, k2};
    ...
    MmDeq(mm2ProblemShape, gmX2, layoutX2, gmWeight2, layoutWeight2, gmScale2, layoutScale2,
        gmPerTokenScale2, layoutPerTokenScale2, gmOutput, layoutOutput, gmWorkspace);
}

// 控制 C - V 按照 1:1 启动
#if defined(__DAV_C220_CUBE__)
static const struct FunLevelMixCoreType mm_deq_swiglu_quant_mm_deq_n128_0_mix_aic_section
__attribute__ ((used, section (".ascend.meta.mm_deq_swiglu_quant_mm_deq_n128_0_mix_aic"))) = {
    {
        {
            F_TYPE_KTYPE,
            sizeof(unsigned int)
...
static const struct FunLevelMixCoreType mm_deq_swiglu_quant_mm_deq_n128_0_mix_aiv_section
__attribute__ ((used, section (".ascend.meta.mm_deq_swiglu_quant_mm_deq_n128_0_mix_aiv"))) = {
    {
        {
            F_TYPE_KTYPE,
            sizeof(unsigned int)
