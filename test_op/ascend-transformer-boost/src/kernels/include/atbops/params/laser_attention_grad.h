 ...
 */
#ifndef ATBOPS_PARAMS_LASER_ATTENTION_GRAD_H
#define ATBOPS_PARAMS_LASER_ATTENTION_GRAD_H
...
struct LaserAttentionGrad {
    ...
    int sparseMode = 0;
    int innerPrecise = 1;
    bool operator==(const LaserAttentionGrad &other) const
    {
...
#endif // ATBOPS_PARAMS_LASER_ATTENTION_GRAD_H
