 ...
 */
#ifndef OPS_ACTIVATION_ACTIVATIONOPERATION_H
#define OPS_ACTIVATION_ACTIVATIONOPERATION_H
#include <memory>
...
public:
    explicit ActivationOperation(const infer::ActivationParam &param);
    ~ActivationOperation() override;
