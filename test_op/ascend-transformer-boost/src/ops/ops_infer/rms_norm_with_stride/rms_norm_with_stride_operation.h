...
namespace atb {
class RmsNormWithStrideOperation : public OperationBase {
public:
    explicit RmsNormWithStrideOperation(const infer::RmsNormWithStrideParam &param);
    ~RmsNormWithStrideOperation() override;
