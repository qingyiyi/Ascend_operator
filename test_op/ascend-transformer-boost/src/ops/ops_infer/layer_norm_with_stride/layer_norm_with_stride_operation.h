 ...
 */
#ifndef OPS_LAYER_NORM_WITH_STRIDE_OPERATION_H
#define OPS_LAYER_NORM_WITH_STRIDE_OPERATION_H
#include "atb/operation/operation_base.h"
#include "atb/infer_op_params.h"

namespace atb {
class LayerNormWithStrideOperation : public OperationBase {
public:
    explicit LayerNormWithStrideOperation(const infer::LayerNormWithStrideParam &param);
    ~LayerNormWithStrideOperation() override;
