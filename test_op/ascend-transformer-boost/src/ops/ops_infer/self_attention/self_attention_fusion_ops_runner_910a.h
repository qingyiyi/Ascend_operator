 ...
 */
#ifndef ATB_SELF_ATTENTION_FUSION_OPS_RUNNER_910A_H
#define ATB_SELF_ATTENTION_FUSION_OPS_RUNNER_910A_H
...
namespace atb {
class SelfAttentionFusionOpsRunner910A : public OpsRunner {
public:
    explicit SelfAttentionFusionOpsRunner910A(const infer::SelfAttentionParam &param);
    ~SelfAttentionFusionOpsRunner910A() override;
