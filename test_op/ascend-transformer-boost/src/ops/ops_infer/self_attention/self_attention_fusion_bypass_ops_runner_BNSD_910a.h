 ...
 */
#ifndef ATB_SELF_ATTENTION_FUSION_BYPASS_OPS_RUNNER_BNSD_910A_H
#define ATB_SELF_ATTENTION_FUSION_BYPASS_OPS_RUNNER_BNSD_910A_H
...
namespace atb {
class SelfAttentionFusionBypassOpsRunnerBNSD910A : public OpsRunner {
public:
    explicit SelfAttentionFusionBypassOpsRunnerBNSD910A(const infer::SelfAttentionParam &param);
    ~SelfAttentionFusionBypassOpsRunnerBNSD910A() override;
...
private:
    ...
    int64_t batchMulsHeadNum_ = 0;
    int64_t maxSeqLen_ = 0;
    int64_t headDim_ = 0;
    Mki::Tensor nullTensor_ = {}; // 空tensor
};
} // namespace atb
#endif // ATB_SELF_ATTENTION_FUSION_OPS_RUNNER_BNSD_910A_H