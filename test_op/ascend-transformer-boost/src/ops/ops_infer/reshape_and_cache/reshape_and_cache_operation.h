 ...
 */
#ifndef OPS_RESHAPE_AND_CACHE_RESHAPEANDCACHEOPERATION_H
#define OPS_RESHAPE_AND_CACHE_RESHAPEANDCACHEOPERATION_H
...
public:
    explicit ReshapeAndCacheOperation(const infer::ReshapeAndCacheParam &param);
    ~ReshapeAndCacheOperation() override;
