...
class TestMLAPrefill(op_test.OpTest):
    ...
    def test_flash_attention_mla_fp16_case1(self):
        ...
        self.set_data_params(dynamic_batch = dynamic_batch,
                             ...
                             op_type = OP_PARAM["type"], mask_type = MASK_TYPE_NO_MASK, tor = tor)
        self.gen_out_tensor()
    ...
    @op_test.only_910b
    def test_flash_attention_mla_fp16_swa_case1(self):
        # unpad encoder
        batch = 16
        kv_head = 1     # kv_head num
        isdecoder = 0       # prefill or decoder
        ...
        OP_NAME = "MLAOperation"
        OP_PARAM = {"type": 1, "qSeqLen":kv_seqLen, "kvSeqLen": kv_seqLen, "headDimV": embeddimV,"headSize": heads, "tor": tor, "maskType": 6, "windowSize": window_size}
        self.set_param(OP_NAME, OP_PARAM)
        self.set_input_formats([self.format_nd] * 13)
        self.set_output_formats([self.format_nd])
        data_type = torch.float16
    ...
    @op_test.only_910b
    def test_flash_attention_mla_fp16_swa_case2(self):
        # unpad encoder
        batch = 1
        kv_head = 1     # kv_head num
        isdecoder = 0       # prefill or decoder
    ...
    @op_test.only_910b
    def test_flash_attention_mla_bf16_swa_case1(self):
        # unpad encoder
        batch = 16
        kv_head = 1     # kv_head num
        isdecoder = 0       # prefill or decoder
    ...
    @op_test.only_910b
    def test_flash_attention_mla_bf16_swa_case2(self):
        # unpad encoder
        batch = 1
        kv_head = 1     # kv_head num
        isdecoder = 0       # prefill or decoder
