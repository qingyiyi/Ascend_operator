...
class TestGmmAdd(op_test.OpTest):
    ...
    @op_test.only_910b
    def testcase_gmm_add_fp16_tn0(self):
        shape = (2, 345, 1280, 567)
        group_list = [256, 1280]
        transA, transB = True, False
        self.common_testcase_910b(shape, group_list, transA, transB, torch.float16)

    @op_test.only_910b
    def testcase_gmm_add_fp16_tn_gn1(self):
    ...
    @op_test.only_910b
    def testcase_gmm_add_fp16_tn_gn3(self):
    ...
    @op_test.only_910b
    def testcase_gmm_add_fp16_tn_gn4(self):
    ...
    @op_test.only_910b
    def testcase_gmm_add_fp16_tn_gn5(self):
