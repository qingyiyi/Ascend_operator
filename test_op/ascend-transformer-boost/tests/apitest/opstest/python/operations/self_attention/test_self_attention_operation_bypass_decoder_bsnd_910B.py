...
class TestFlashAttentionDataGenerator():
    ...
    def test_flash_attention_case4(self):
        ...
        return [self.q, self.k, self.v, self.mask.to(torch.float16), self.kv_seqlen, self.q_seqlen, self.layer_id, self.golden_out]
...
class TestFlashAttentionEncoderOperationBNSD(operation_test.OperationTest):
    ...
    def test(self):
        ...
        data = dataGenerator.test_flash_attention_case4()
        ...
        PARAM = json.dumps({"headNum": 20, "kvHeadNum":20, "qkScale": 1.0,
                            "maskType": 1, "kvcacheCfg":1,"calcType":2})
