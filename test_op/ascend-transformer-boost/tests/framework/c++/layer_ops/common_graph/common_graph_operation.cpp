...
*/
#include "layer_ops/common_graph/common_graph_operation.h"
...
atb::Status CreateCommonGraphOperation(const CommonGraphParam &param, atb::Operation **operation)
{
    ...
    CreateOperation(linearParam, &matmulNode.operation);
    matmulNode.inTensorIds = {IN_INPUTTENSOR, IN_WEIGHTTENSOR};
    matmulNode.outTensorIds = {INTERMIDATE_MATMUL_OUT};
    ...
    opGraph.inferShapeFunc = [=](const atb::SVector<atb::TensorDesc> &inTensorDescs,
        ...
        outTensorDescs.at(0).shape.dims[0] = 8;
