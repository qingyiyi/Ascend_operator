...
class TestMLAPrepross(operation_test.OperationTest):
    ...
    def calc_vec_mm_atb_data(self, N, headNum, data_type):
        ...
        print("blockSize_calc_vec_mm_atb_data is %f", blockSize)
        blockSize
        headdim = 576
    ...
    def calc_vec_mm_atb_data_bf16(self, N, headNum, data_type):
        ...
        blockNum = 192
        blockSize = block_size
        print("blockSize_calc_vec_mm_atb_data_bf16 is %f", blockSize)
    ...
    def test_mla_preprocess_split_block128_headNum128(self):
        if not operation_test.get_soc_version() == 'Ascend910B':
            print("this testcase only supports Ascend910B")
            return
        self.cacheMode = 1
