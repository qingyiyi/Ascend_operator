...
QUANTMIN = -128
block_list = [128,256]
block_size = random.choice(block_list)
...
class TestMLAPrepross(operation_test.OperationTest):
    #def __init__(self):
        #初始化block_siz
        #super().__init__()
        #self.block_size = random.choice([128, 256])
    ...
    def calc_vec_mm_atb_data(self, N, headNum, data_type):
        ...
        print("blockSize is %f", blockSize)
        blockSize
        headdim = 576
    ...
    def calc_vec_mm_atb_data_bf16(self, N, headNum, data_type):
        ...
        blockNum = 192
        blockSize = block_size
        print("blockSize_bf16 is %f", blockSize)
    ...
    def test_mla_preprocess(self):
        ...
        self.cacheMode = 0
        N = 1024
        headNum_list = [32, 128, 16, 64]
        headNum = random.choice(headNum_list)
