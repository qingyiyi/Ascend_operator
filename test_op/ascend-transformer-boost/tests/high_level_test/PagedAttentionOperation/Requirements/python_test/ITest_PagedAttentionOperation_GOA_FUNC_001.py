...
MASK_TYPE = 0
PARAM = json.dumps(
    {"headNum": 16, "qkScale": (1 / float(math.sqrt(128))), "kvHeadNum": kv_head_num, "maskType": MASK_TYPE})
    ...
    def test(self):
        ...
        for i in range(50):
            if MASK_TYPE != 0:
                ...
                self.execute(OP_NAME, PARAM, [in_tensors[0], in_tensors[1], in_tensors[2], in_tensors[3], in_tensors[4]])
