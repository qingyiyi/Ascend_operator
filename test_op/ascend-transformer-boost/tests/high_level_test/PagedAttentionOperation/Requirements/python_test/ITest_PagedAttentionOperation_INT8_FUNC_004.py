...
# (q, k, v, block_table, context_lens, kDescale, vDescale, pScale) = (
    data_generator.q,
...
# data = [q, k, v, torch.from_numpy(block_table), torch.from_numpy(context_lens), kDescale, vDescale, pScale]
...
PARAM = json.dumps({"headNum":32, "qkScale": (1 / 128 ** 0.5), "kvHeadNum": 2, "maskType": 1, "compressType": 0, "quantType": 2, "outDataType": 27})
