    ...
    def test_flash_attention_case_fa_encoder_nocache_bf16_fav3_int8_online(self):
        ...
        if not self.fav3:
            ...
            ret = [self.q_int8, self.k_int8, self.v_int8, self.mask.to(data_type), self.kv_seqLen, torch.tensor(self.q_scale, dtype=torch.float), 
                            ...
                            torch.tensor(self.v_offset, dtype=torch.int32), self.golden_out]
            return ret
...
data = data_generator.test_flash_attention_case_fa_encoder_nocache_bf16_fav3_int8_online()
param_seqlen = data[4]
...
PARAM = json.dumps({"headNum": 20, "qkScale": tor, "kvHeadNum": 20,
                    "calcType": 3, "maskType": 1, "isTriuMask": 0, "kernelType": 0, "quantType": 3, "outDataType": 27})
