...
data = data_generator.test_flash_attention_case_fa_encoder_nocache_fp16_fav3_int8_online()
param_seqlen = data[4]
...
PARAM = json.dumps({"headNum": 2, "qkScale": 1, "kvHeadNum": 2,
                    "calcType": 3, "maskType": 1, "isTriuMask": 0, "kernelType": 0, "quantType": 3, "outDataType": 1})
